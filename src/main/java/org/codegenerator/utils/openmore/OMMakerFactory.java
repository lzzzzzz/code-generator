...
public class OMMakerFactory{
     ...
     * @param root: 所需元素
     * */
    public static void freeMaker( int flag , String fileName , Map<String, Object> root ) throws Exception{
     ...
     * @param root: 所需元素
     * */
    public static String freeMaker( int flag , Map<String, Object> root ) throws Exception{
        if(flag<OMMakerConfig.FLAG_CREATE_DTO_API||flag>OMMakerConfig.FLAG_CREATE_CONTROLLER_COMMON){
            throw new RuntimeException("指定生成文件类型不合法："+flag);
        }
        String mode_file_path="";
        ...
        String data=FreeMakerFactory.getInstance().freeMaker(mode_file_path , root);
        return data;
